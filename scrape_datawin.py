...
with open('datawin.csv', 'w', newline='') as csvfile:
	...
	for w in get_weibo_tweets_by_name('德塔文影视观察'):
		...
		if '肖战' in blog_body and '电视剧景气指数' in blog_body and 'original_pic' in w['mblog']:
			post_url = w['scheme']
			...
			pic_file_path = './datawin/' + dt_str.replace('/', '_') + '_' + 'datawin.jpg'
